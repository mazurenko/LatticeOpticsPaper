...
%DIF DEL ../submission_pr_applied/latticeoptics.tex   Sat Dec 29 13:41:05 2018
%DIF ADD latticeoptics.tex                            Sat Dec 29 13:41:05 2018
...
}\DIFdelend \DIFaddbegin \DIFadd{This device allows us to drive the AOM with a single, clean tone.
%DIF > The spectrum and relative intensity noise of the PLL can be found in Fig.~\ref{fig:pll}.
}\DIFaddend Vitally, the spectrum of the PLL exhibits phase noise comparable to that of a typical VCO \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{but }\DIFaddend without the slow frequency drift characteristic to these devices.
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\textbf{\DIFdel{PLL performance}} %DIFAUXCMD
\DIFdel{(a) The spectrum of the PLL, exhibiting phase noise of better than $-90$ dBc/Hz at $100$~kHz away from the carrier. (b) The RIN of the local oscillator based on the PLL. The noise level is seen to be at or below the noise floor of the measurement device.}}%DIFAUXCMD
%DIFDELCMD < \label{fig:pll}
