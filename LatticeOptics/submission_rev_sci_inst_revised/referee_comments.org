# -*- mode: Org; mode: visual-line; mode: visual-fill-column -*-
# Time-stamp: "2019-01-10 10:52:23 sb"
...
We have adapted the referee's formulation.
...
To make the above points more clear and to give more credit to the large body of work from the LIGO community, we have modified the introdution.
