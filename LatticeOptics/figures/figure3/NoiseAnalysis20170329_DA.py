...
if __name__ == '__main__':
    ...
    noise_curves_DA['DA'] = NoiseCurve('20170329_DA_noise', 1.95, lo_filename='DA_fixed_lo.txt',
    ...
    make_rin_plot(noise_curves_DA_scanning, is_save=True, save_name='da_rin_scan', x_window=[.8e3, 10e6],
                  y_window=[-130, -30])

    make_rin_plot(noise_curves_DA, is_save=True, save_name='da_rin', x_window=[.8e3, 10e6],
                  y_window=[-175, -120])
