...
This is done by closing a mechanical shutter in front of the photodiode and setting the set-point to a high value, which quickly winds up the integrator to its maximum output.
